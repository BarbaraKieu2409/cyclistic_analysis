...
/*
 * Based on the result in above, I will state that almose casual use bycycle between 6 and 18 minutes, 
 * and almost member use bycycle between 4 and 13 minutes in quarter 4*/
...
-- Stats casual which ride_length > 18 minutes and < 6 minutes | 6 <= ride_length <= 18 minutes by rideable_type
SELECT 
	'quarter_4' AS quarter_name,
	member_casual,
	rideable_type,
	'use more than 18m' AS ride_length,
	COUNT(*) AS total
FROM quarter_4
WHERE 
	TIME_TO_SEC(ride_length) > 18*60
	AND
...
SELECT
	...
	member_casual,
	rideable_type,
	'use between 6 and 18m' AS ride_length,
	COUNT(*) AS total
FROM quarter_4
WHERE 
	TIME_TO_SEC(ride_length) >= 6 * 60
...
SELECT 
	...
	member_casual,
	rideable_type,
	'use more than 13m' AS ride_length,
	COUNT(*) AS total
FROM quarter_4
WHERE 
	TIME_TO_SEC(ride_length) > 13*60
	AND
...
SELECT
	...
	member_casual,
	rideable_type,
	'use between 4 and 13m' AS ride_length,
	COUNT(*) AS total
FROM quarter_4
WHERE 
	TIME_TO_SEC(ride_length) >= 4 * 60
